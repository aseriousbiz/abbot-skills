/* ------------------------------------------------------------------------------------------------
Description: Subscribe to Cloud Events webhook subscriptions (such as from Azure EventGrid) and report them to a chat room. This supports the Cloud Events WebHook Spec v1.0.1: https://github.com/cloudevents/spec/blob/v1.0.1/http-webhook.md
